...
@pytest.mark.asyncio
async def test_memory_store_save_and_search(pg_store):
    store = pg_store
...
@pytest.mark.asyncio
async def test_memory_store_save_and_search_async(pg_store):
...
@pytest.mark.asyncio
async def test_memory_store_recent(pg_store):
    store = pg_store
...
@pytest.mark.asyncio
async def test_memory_store_audit(pg_store):
    store = pg_store
